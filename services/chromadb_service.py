...
def index_documents(documents, persist_directory="data/db_persistent", batch_size=100000, collection_name: str = 'website_docs'):
    """
...
def get_relevant_documents(query, n_results=3, persist_directory="data/db_persistent"):
    """
