...
def populate_chroma_db():
    ...
    """
    fake_documents = [
        Document(page_content="This is a fake document about AI.", metadata={"url": "https://example.com"}),
        Document(page_content="This is another fake document about technology.", metadata={"url": "https://example.org"})
    ]
